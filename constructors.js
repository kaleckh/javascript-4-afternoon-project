...
Movie.prototype.changeRating = function(ratingTwo) {
    return (this.rating + ratingTwo) / 2
}
...
User.prototype.removeSavedPost = function(id) {
    this.savedPosts = this.savedPosts.filter(function(savedPost) {
        if (savedPost.id === id) {
            return false
...
User.prototype.changePostRating = function(id, newRating) {
    this.savedPosts = this.savedPosts.map(function(savedPost) {
        if (savedPost.id === id) {
            savedPost.rating = newRating
            return savedPost;
        } else {
            return savedPost;
        }
